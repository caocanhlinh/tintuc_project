                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        @endif
                                        <form action="admin/tintuc/edit/{{$tintuc->id}}" method="POST" role="form" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label>Tiêu Đề</label>
                                                <input class="form-control" value="{{$tintuc->TieuDe}}" name="TieuDe" placeholder="Nhập tiêu đề bài viết..." />
                                            </div>
                                            <div class="form-group">
                                                <label>Tóm Tắt</label>
                                                <textarea class="form-control" rows="3" maxlength="100" name="TomTat">{{$tintuc->TomTat}}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>Bài Viết</label>
                                                <textarea class="form-control" id="editor" name="content" rows="3">{{$tintuc->NoiDung}}</textarea>
                                            </div>
                                ...
                                <div  class="col-md-4">
                                    <div class="col-lg-12" style="padding-bottom:120px">
                                        ...
                                        <div class="form-group">
                                            <label>Từ Khóa</label>
                                            <input class="form-control" value="{{$tintuc->Tags}}" name="Tags" placeholder="Please Enter Category Keywords" />
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <!-- <label>
                                              ...
                                              <label>
                                                <div class="form-control text-center">
                                                    <img id="preimg" class="img-thumbnail"  src="image/tintuc/{{$tintuc->Hinh}}" alt="Add image" /><br>
