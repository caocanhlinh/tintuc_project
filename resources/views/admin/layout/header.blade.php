    ...
    <i data-count="0" class="fa fa-bell-o fa-lg notification-icon"></i></a>
      <ul class="app-notification dropdown-menu dropdown-menu-right">
        ...
        <div class="app-notification__content">
          @foreach($noti as $thongbao)
          <li>
            <a class="app-notification__item" href="javascript:;">
              <span class="app-notification__icon">
              <span class="fa-stack fa-lg">
              <img src="https://api.adorable.io/avatars/71/{{(rand()* (71 - 20 + 1)).'.png'}}" class="rounded-circle text-primary" alt="40x40" style="width: 40px; height: 40px;">
              </span>
              </span>
              <div>
              <p class="app-notification__message">{{$thongbao->NoiDung}}</p>
              <p class="app-notification__meta">{{Carbon::parse($thongbao->created_at)->diffForHumans()}}</p>
              </div>
            </a>
          </li>
          @endforeach
