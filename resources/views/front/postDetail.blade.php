...
<article id="post-16" class="post-16 post type-post status-publish format-standard has-post-thumbnail hentry category-business">
	<header class="entry-header clear">
		...
		<div class="entry-category-icon"><a href="https://www.happythemes.com/demo/newsnow/category/business/" title="View all posts in Business">{{$tintuc->loaitin->theloai->Ten}}</a> </div>
	...
	<span class="entry-comment"><a href="https://www.happythemes.com/demo/newsnow/laptop-on-wooden-desk-in-office-open-space/#respond" class="comments-link">{{$tintuc->loaitin->Ten}}</a></span>
	<div class="entry-author text-right">
		...
		<div class="fb-share-button" data-href="http://caocanhlinh.local/detail/post/{{$tintuc->id}}" data-layout="button" data-size="large"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fcaocanhlinh.local%2Fdetail%2Fpost%2F923&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Chia sẻ</a></div>
	</div>
	...
	<div class="entry-content">
		...
		<p><img src="image/tintuc/{{$tintuc->Hinh}}" id="myImg" alt="{{$tintuc->TieuDe}}" width="4000" height="2667" class="alignnone size-full wp-image-17"></p>
	<p>{!!$tintuc->NoiDung!!}</p>
	</div><!-- .entry-content -->
...
<div id="comments" class="comments-area">
		...
		<div id="respond" class="comment-respond">
			...
			<div id="face" class="tabcontent form-group" style="display: none;">
			  	<div id="fb-root"></div>
				<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v3.3&appId=1912967308968186&autoLogAppEvents=1"></script>
				<div class="fb-comments" data-href="http://caocanhlinh.local/detail/post/{{$tintuc->id}}" data-width="30%" data-numposts="5"></div>
			</div>
