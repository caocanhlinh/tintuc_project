<?php /* D:\xampp\htdocs\caocanhlinh\resources\views/admin/theloai/list.blade.php */ ?>
              ...
              <tr>
                ...
                <td>
                    <form action="" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="btn-group pull-right"><a class="btn btn-primary" href="admin/theloai/edit/<?php echo e($cat->id); ?>"><i class="fa fa-lg fa-edit"></i>Sửa</a><a class="btn btn-danger delete<?php echo e($cat->id); ?>" href="admin/theloai/delete/<?php echo e($cat->id); ?>/<?php echo e('token'.hash('sha512',rand().$_SERVER['REMOTE_ADDR'].$_SERVER['HTTP_USER_AGENT'])); ?>"><i class="fa fa-lg fa-trash"></i>Xóa</a></div>
                    </form>
                </td>
              </tr>
