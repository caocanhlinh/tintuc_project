<?php /* /home/vagrant/code/caocanhlinh/resources/views/front/layout/header.blade.php */ ?>
	...
	<header id="masthead" class="site-header clear">
					...
					<ul id="secondary-menu" class="sf-menu sf-js-enabled sf-arrows" style="touch-action: pan-y;">
						...
						<?php $__currentLoopData = $theloai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if($cat->tintuc->count() != 0): ?>
								<li id="menu-item-113" class="navactive menu-item menu-item-type-taxonomy menu-item-object-category menu-item-113"><a class="active" href="category-<?php echo e($cat->id); ?>"><?php echo e($cat->Ten); ?></a>
								</li>
							<?php endif; ?>
		...
		<div class="mobile-menu clear">
			...
			<div class="container">
				...
				<?php $__currentLoopData = $theloai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<?php if($cat->tintuc->count() != 0): ?>
						<li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-113"><a href="category-<?php echo e($cat->id); ?>"><?php echo e($cat->Ten); ?></a></li>
					<?php endif; ?>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</ul></div></div>
			</div><!-- .container -->
