<?php /* /home/vagrant/code/caocanhlinh/resources/views/front/layout/footer.blade.php */ ?>
			...
			<div class="container">
				...
				<div class="footer-column footer-column-4">
					<div id="categories-3" class="widget footer-widget widget_categories">		
						<ul>
							<li class="cat-item cat-item-2"><a href="https://www.happythemes.com/demo/newsnow/category/business/" title="You can enter a simple description of this category here"><?php echo e($cat->Ten); ?></a> (10)
							</li>
						</ul>
					</div> 
				</div>
