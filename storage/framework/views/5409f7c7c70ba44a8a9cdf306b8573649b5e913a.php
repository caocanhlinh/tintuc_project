<?php /* D:\xampp\htdocs\caocanhlinh\resources\views/front/layout/aside.blade.php */ ?>
<aside id="secondary" class="widget-area sidebar">
	...
	<div id="happythemes-ad-13" class="widget widget_ad ad-widget"><div class="adwidget"><a href="http://www.happythemes.com/join/" target="_blank"><img src="image/ads/300-1.png" alt="Ad Widget"></a></div></div><div id="search-3" class="widget widget_search"><form role="search" method="get" class="search-form" action="https://www.happythemes.com/demo/newsnow/">
			...
			</form></div><div id="recent-comments-3" class="widget widget_recent_comments"><h2 class="widget-title"><span>Recent Comments</span></h2><ul id="recentcomments"><li class="recentcomments"><span class="comment-author-link">Allen</span> on <a href="https://www.happythemes.com/demo/newsnow/young-girl-with-pink-shoes-on-longboard/#comment-12">Young Girl with Pink Shoes on Longboard</a></li><li class="recentcomments"><span class="comment-author-link">Allen</span> on <a href="https://www.happythemes.com/demo/newsnow/young-girl-with-pink-shoes-on-longboard/#comment-11">Young Girl with Pink Shoes on Longboard</a></li><li class="recentcomments"><span class="comment-author-link">Allen</span> on <a href="https://www.happythemes.com/demo/newsnow/san-francisco-bay-area-beautiful-sunset-evening-cityscape/#comment-10">San Francisco Bay Area Beautiful Sunset Evening Cityscape</a></li><li class="recentcomments"><span class="comment-author-link">Allen</span> on <a href="https://www.happythemes.com/demo/newsnow/young-woman-enjoying-morning-breakfast-in-bed/#comment-9">Young Woman Enjoying Morning Breakfast in Bed</a></li></ul></div><div id="categories-4" class="widget widget_categories"><h2 class="widget-title"><span>Categories</span></h2>		<ul>
	<li class="cat-item cat-item-2"><a href="https://www.happythemes.com/demo/newsnow/category/business/" title="You can enter a simple description of this category here">Business</a>
</li>
	<li class="cat-item cat-item-6"><a href="https://www.happythemes.com/demo/newsnow/category/entertainment/" title="This is a sample description of this awesome category">Entertainment</a>
</li>
	<li class="cat-item cat-item-3"><a href="https://www.happythemes.com/demo/newsnow/category/fashion/" title="You can enter a simple description of this category here">Fashion</a>
</li>
	<li class="cat-item cat-item-1"><a href="https://www.happythemes.com/demo/newsnow/category/social-media/" title="This is a sample description of this awesome category">Social Media</a>
</li>
	<li class="cat-item cat-item-4"><a href="https://www.happythemes.com/demo/newsnow/category/sports/" title="Includes all forms of competitive physical activity or games.">Sports</a>
</li>
	<li class="cat-item cat-item-5"><a href="https://www.happythemes.com/demo/newsnow/category/technology/" title="You can enter a simple description of this category here">Technology</a>
</li>
		</ul>
